...
<body>
    <div class="background">
        ...
        <img src="Imagens/imagem (1) copiar.png" alt="">   
    </div>
    ...
    <div class="app">
        <header>
            <ul class="nav_navegation">
                <li>
                    <a href="index.php"><img class="imagemLogo" src="Imagens/Logo PAP.jpg" alt="Logo"></a>
                </li>
                <li class="nav-item">
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
    ...
    <main>
        <div class="Frase">
            <img src="Imagens/pap site logo.png" alt="" class="fraseimagem">
    ...
    <main class="download">
        ...
        <p>O jogo segue um estilo stealth, que consiste em roubar diamantes, mas entretanto acontece algo insperado!</p>
        <p>O jogo está ainda em desenvolvimento.</p>
        <button type="button" class="jogo"> <a  href="Download/Jogo3.rar" target="_blank" rel="noopener noreferrer" download>Transferir Jogo</a></button>
        <br>
        <br>
        <p>Esperemos que gostem!</p>
